...
export default class location extends Component {
  ...
  async componentDidMount() {
    ...
    await this.loadCharactersToLocations();
  }

  async loadLocations() {
    // console.log(this.props.match.params);
    const locationsId = this.props.match.params.locationId;
    const URL_LOCATION = `https://rickandmortyapi.com/api/location/${locationsId}`;
  ...
  async loadCharactersToLocations() {
    // console.log(this);
    const locationsId = this.props.match.params.locationId;
    const URL_LOCATION = `https://rickandmortyapi.com/api/location/${locationsId}`;
    const llamada = await axios.get(URL_LOCATION);
